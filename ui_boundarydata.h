/********************************************************************************
** Form generated from reading UI file 'boundarydata.ui'
**
...
#ifndef UI_BOUNDARYDATA_H
#define UI_BOUNDARYDATA_H
...
public:
    ...
    QLineEdit *Led_WaterDisp;
    QPushButton *Btn_UploadFile;
    QHBoxLayout *horizontalLayout_2;
    QLineEdit *Led_WaterHeight;
    QPushButton *Btn_UploadFile_2;
    ...
    void setupUi(QFrame *boundaryData)
    {
        ...
        verticalLayout_2 = new QVBoxLayout(boundaryData);
        ...
        verticalLayout_2->addWidget(Lbl_PatchLoc);
        ...
        verticalLayout_2->addWidget(Cmb_PatchLoc);
        ...
        verticalLayout_2->addWidget(Cmb_UBC);

        verticalLayout = new QVBoxLayout();
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        Led_WaterDisp = new QLineEdit(boundaryData);
        Led_WaterDisp->setObjectName(QString::fromUtf8("Led_WaterDisp"));
        Led_WaterDisp->setReadOnly(true);

        horizontalLayout->addWidget(Led_WaterDisp);
        ...
        Led_WaterHeight = new QLineEdit(boundaryData);
        Led_WaterHeight->setObjectName(QString::fromUtf8("Led_WaterHeight"));
        Led_WaterHeight->setReadOnly(true);

        horizontalLayout_2->addWidget(Led_WaterHeight);

        Btn_UploadFile_2 = new QPushButton(boundaryData);
        Btn_UploadFile_2->setObjectName(QString::fromUtf8("Btn_UploadFile_2"));
        Btn_UploadFile_2->setFont(font1);
        Btn_UploadFile_2->setToolTipDuration(10000);

        horizontalLayout_2->addWidget(Btn_UploadFile_2);
        ...
        verticalLayout_2->addWidget(Cmb_WaveType);
        ...
        DSpBx_UMeanY->setDecimals(4);
        DSpBx_UMeanY->setMinimum(-1000000000.000000000000000);
        DSpBx_UMeanY->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_DirnZ->setDecimals(4);
        DSpBx_DirnZ->setMinimum(-1000000000.000000000000000);
        DSpBx_DirnZ->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_OZ->setDecimals(4);
        DSpBx_OZ->setMinimum(-1000000000.000000000000000);
        DSpBx_OZ->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_OY->setDecimals(4);
        DSpBx_OY->setMinimum(-1000000000.000000000000000);
        DSpBx_OY->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_DirnY->setDecimals(4);
        DSpBx_DirnY->setMinimum(-1000000000.000000000000000);
        DSpBx_DirnY->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_UMeanX->setDecimals(4);
        DSpBx_UMeanX->setMinimum(-1000000000.000000000000000);
        DSpBx_UMeanX->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_UMeanZ->setDecimals(4);
        DSpBx_UMeanZ->setMinimum(-1000000000.000000000000000);
        DSpBx_UMeanZ->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_DirnX->setDecimals(4);
        DSpBx_DirnX->setMinimum(-1000000000.000000000000000);
        DSpBx_DirnX->setMaximum(1000000000.000000000000000);
        ...
        DSpBx_OX->setDecimals(4);
        DSpBx_OX->setMinimum(-1000000000.000000000000000);
        DSpBx_OX->setMaximum(1000000000.000000000000000);
        ...
        verticalLayout_2->addWidget(Cmb_PresBC);
        ...
        DSpBx_Pres->setDecimals(4);
        DSpBx_Pres->setMinimum(-1000000000000.000000000000000);
        DSpBx_Pres->setMaximum(10000000000000.000000000000000);

        HLY_Pres->addWidget(DSpBx_Pres);

        HLY_Pres->setStretch(0, 1);

        verticalLayout_2->addLayout(HLY_Pres);

        VSp = new QSpacerItem(20, 73, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_2->addItem(VSp);
    ...
    void retranslateUi(QFrame *boundaryData)
    {
        ...
        Cmb_UBC->setItemText(0, QCoreApplication::translate("boundaryData", "Select velocity boundary condition", nullptr));
        Cmb_UBC->setItemText(1, QCoreApplication::translate("boundaryData", "General: SW solutions", nullptr));
        Cmb_UBC->setItemText(2, QCoreApplication::translate("boundaryData", "Inlet: Constant velocity", nullptr));
        Cmb_UBC->setItemText(3, QCoreApplication::translate("boundaryData", "Inlet: Moving wall (OSU Flume)", nullptr));
        Cmb_UBC->setItemText(4, QCoreApplication::translate("boundaryData", "Inlet: Moving wall (General flume)", nullptr));
        Cmb_UBC->setItemText(5, QCoreApplication::translate("boundaryData", "Outlet: zeroGradient", nullptr));
        Cmb_UBC->setItemText(6, QCoreApplication::translate("boundaryData", "Outlet: inletOutlet", nullptr));
        Cmb_UBC->setItemText(7, QCoreApplication::translate("boundaryData", "Wall: noSlip", nullptr));
...
#endif // QT_CONFIG(tooltip)
        Btn_UploadFile->setText(QCoreApplication::translate("boundaryData", "Wall displacement", nullptr));
#if QT_CONFIG(tooltip)
        Btn_UploadFile_2->setToolTip(QCoreApplication::translate("boundaryData", "Upload files related to the boundary patch", nullptr));
#endif // QT_CONFIG(tooltip)
        Btn_UploadFile_2->setText(QCoreApplication::translate("boundaryData", "Water height", nullptr));
...
"Phase, Angle", nullptr));
        ...
        Cmb_PresBC->setItemText(1, QCoreApplication::translate("boundaryData", "zeroGradient", nullptr));
        Cmb_PresBC->setItemText(2, QCoreApplication::translate("boundaryData", "fixedValue", nullptr));
