#include "GeneralEvt.h"
#include "ui_GeneralEvt.h"
...
// Main window
//*********************************************************************************
GeneralEvt::GeneralEvt(RandomVariablesContainer *theRV, QWidget *parent)
    : SimCenterAppWidget(parent), theRemoteService(NULL)
    , ui(new Ui::GeneralEvt)
{
    // Start the UI
    ui->setupUi(this);
...
bool GeneralEvt::outputToJSON(QJsonObject &jsonObject)
{
  jsonObject["EventClassification"]="Hydro";
  jsonObject["Application"] = "GeneralEvt";
...
bool GeneralEvt::inputFromJSON(QJsonObject &jsonObject)
{
  return false;
}

bool
GeneralEvt::outputAppDataToJSON(QJsonObject &jsonObject)
{
    jsonObject["EventClassification"]="Hydro";
    jsonObject["Application"] = "GeneralEvt";
    QJsonObject dataObj;
...
bool
GeneralEvt::inputAppDataFromJSON(QJsonObject &jsonObject)
{
  return true;
}

bool
GeneralEvt::copyFiles(QString &dirName)
{
  return false;
}

void
GeneralEvt::errorMessage(QString message){
...
// Clear all data
//*********************************************************************************
void GeneralEvt::clearAllData(void)
{
...
//*********************************************************************************
void GeneralEvt::refresh_projsettings()
{
...
//*********************************************************************************
void GeneralEvt::on_Btn_Generate_Files_clicked()
{
...
// Save JSON file
//*********************************************************************************
void GeneralEvt::saveJson(QString wdir,QString pname, QJsonDocument jsondoc)
{
...
//*********************************************************************************
void GeneralEvt::on_SimOptions_itemDoubleClicked(QTreeWidgetItem *item, int column)
{
...
void GeneralEvt::on_Btn_SubTACC_clicked()
{
    // Get directory and project name for writing JSON file
    QMap<QString, QString> *singleDataSet = allData.value(0);
    QString wdir = singleDataSet->value("Work directory");
