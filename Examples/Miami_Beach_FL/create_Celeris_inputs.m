...
dx=2.0; % uniform grid size to use in model - the loaded bathy files will be interpolated to this grid size
...
Thetap=180; % mean direction (deg w.r.t. numerical grid) 0=from west, 90=from south, 180=from east, -90 or 270 from north

%  Boundary conditions - at least one of the boundaries should be = 2
west_boundary_type=1; % west_boundary_type, 0=solid wall, 1=sponge layer, 2= waves loaded from file, created by spectrum_2D above
east_boundary_type=2; % east_boundary_type, 0=solid wall, 1=sponge layer, 2= waves loaded from file, created by spectrum_2D above
