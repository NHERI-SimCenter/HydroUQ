...
dx=0.05; % uniform grid size to use in model - the loaded bathy files will be interpolated to this grid size
...
% Waves
Hmo=1;  % Spectral wave height (m)
Tp=5;  % peak period (sec)
