...
def process_example(example, base_dir, tmp_dir, cache_dir):
    ...
    input_file = os.path.join(base_dir, "HydroUQ", "Examples", example.get("inputFile", ""))
    ...
    try:
        ...
        result = subprocess.run(
            [
                ...
                os.path.join(
                    base_dir,
                    "SimCenterBackendApplications/applications/Workflow/sWHALE.py",
                ),
                "runningLocal",
                input_file,
                os.path.join(
...
def main():
    ...
    # Constants
    pwd = os.getcwd()
    json_file = os.path.join(pwd, "HydroUQ", "Examples", "Examples.json")
